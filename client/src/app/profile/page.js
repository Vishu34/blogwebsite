...
const Profile = () => {
  ...
  const { userdata, setuserdata, files } = UseProfileContext();
            ...
            <Box className="w-[100%] p-2 md:p-0 md:w-[80%] md:mx-auto rounded-md my-10  text-gray-600">
              <Box className="flex flex-col-reverse md:flex md:flex-row md:space-x-4   space-y-4 md:space-y-0">
                ...
                <Box className="space-y-1 w-[100%] md:w-[30%]">
                  ...
                  <Typography className="text-xs"> {username ? username : "@username"}</Typography>
                  ...
                  <Box className="flex space-x-2">
                    ...
                    <Typography className="text-xs"> {account_info?.total_reads ? account_info.total_reads : "3"} Reads</Typography>
                  </Box>
                  ...
                  <Button
                    ...
                    className="bg-black px-4  hover:text-black hover:bg-gray-200 font-medium text-white rounded-full"
                  >
